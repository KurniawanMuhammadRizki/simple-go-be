...
func (cfg *AppConfig) Run() {
	...
	transactionDetailRepository := repository.NewTransactionDetailRepository(cfg.Log)
	...
	transactionDetailController := http.NewTransactionDetailController(&transactionDetailUseCase, cfg.Log)
